...
### 6. DNS
- 配置文件: [/etc/bind/named.conf.options](config/named.conf.options)  [/etc/bind/named.conf.local](config/named.conf.local)  [/etc/bind/db.cuc.edu.cn](config/db.cuc.edu.cn)
